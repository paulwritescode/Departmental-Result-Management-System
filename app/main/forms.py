...
class AddMarksForm(FlaskForm):
    cat_marks = FloatField('CAT Marks', validators=[DataRequired(), NumberRange(min=0, max=100)])
    assignment_marks = FloatField('Assignment Marks', validators=[DataRequired(), NumberRange(min=0, max=100)])
    practical_marks = FloatField('Practical Marks', validators=[DataRequired(), NumberRange(min=0, max=100)])
    exam_marks = FloatField('Exam Marks', validators=[DataRequired(), NumberRange(min=0, max=100)])
