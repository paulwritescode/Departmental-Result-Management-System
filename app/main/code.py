...
def day1():
    ...
    print(
        f"type is {type(daysinaweek*weeksinayear*hoursinaday)} and total number is{daysinaweek*hoursinaday*weeksinayear}"
    )
...
def day2():
    ...
    print(
        "the salary of the developer per week is",
        weeklysalary,
        ",",
        "per month",
        Monthlysalary,
...
def day3():
    ...
    print(
        f"My name is {name.capitalize()}, born in and my hobbies are {hobby1} and {hobby2}"
    )
...
def day4():
    ...
    print(movy)
    movy.append(
        (input("Title"), input("Director"), input("release_year"), input("Budget"))
    )
    print(movy)
    movy.pop(0)
    print(movy)
